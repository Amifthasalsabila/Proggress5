...
/**
 * Write a description of class Pimkys here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class Pimkys extends Actor
{
    private double g = 1;
    private int y = 200;
    ...
    /**
     * Act - do whatever the Pimkys wants to do. This method is called whenever
    ...
    public void act()
    {
        ...
        //jika menabrak pipa maka Pimkys mati
        if(isTouchpipe()){
            isalive = false;
        }
